...
export default async function Page() {
  // get the data for the cabins
  const cabinLength = (await getCabins()).length;

  // console.log(cabinLength);
    return (
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
        <div className="col-span-3">
          ...
          <div className="space-y-8">
            ...
            <p>
              Our {cabinLength} luxury cabins provide a cozy base, but the real freedom and
